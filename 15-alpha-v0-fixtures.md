...
Alpha 还需要补充 `report.export`、`content.moderate`、报告线商品包、销端记录和市场反馈样例。
...
```json
{
  ...
  "nodes": [
    ...
    },
    {
      ...
      "config": {
        "allowed_actions": ["approve", "edit", "rerun"]
      }
    },
    {
      "node_id": "search_plan",
    ...
    },
    {
      ...
      "config": {
        "allowed_actions": ["approve", "edit", "rerun", "reject"]
      }
    },
    {
    ...
    },
    {
      ...
      "config": {
        "allowed_actions_by_role": {
          "creator": ["approve", "edit", "rerun"],
          "operator": ["approve", "edit", "rerun", "reject", "override"]
        }
      }
    },
    {
...
```json
{
  ...
  "assets": [
    {
      ...
      "uri": "asset://reports/ai-km/v1/report.pdf",
  ...
  "preview_assets": [
    {
      ...
      "uri": "asset://reports/ai-km/v1/preview.pdf",
  ...
  "cover": "asset://reports/ai-km/v1/cover.png",
